...
public class VictoriaMetricsAdapter implements TSDBAdapterIF {
    ...
    ////
    private String[] getSeriesByLabelKV(final String key, final String value) throws TSDBBenchmarkException {
    ...
    private void deleteSeries(final String seriesName) throws TSDBBenchmarkException {
